...
/// CLI for geckofuzz for EVM smart contracts
#[derive(Parser, Debug)]
...
pub struct EvmArgs {
    ...
    /// Detectors enabled (all, high_confidence, ...). Refer to https://docs.geckofuzz.rs/docs-evm-contract/detecting-common-vulns
